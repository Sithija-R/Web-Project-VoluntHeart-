...
import { FIND_USER_BY_NAME_FAILURE, FIND_USER_BY_NAME_SUCCESS, FOLLOW_USER_FAILURE, FOLLOW_USER_SUCCESS, GET_USER_FAILURE, GET_USER_SUCCESS, LOGIN_USER_FAILURE, LOGIN_USER_SUCCESS, LOGOUT, REGISTER_USER_FAILURE, REGISTER_USER_SUCCESS, UPDATE_USER_FAILURE, UPDATE_USER_SUCCESS } from "./ActionsType"
...
export const findUserByName =(keyword)=>async(dispatch)=>{
    try {
        const {data} = await api.get(`api/user/profile/${keyword}`);
...
export const googleLoginhandler= (googleId,fullName,email,profilePic)=>async(dispatch)=>{
  ...
  export const updateUserProfile =(userData)=>async(dispatch)=>{
    try {
        const {data} = await api.post(`api/user/profile/`,userData);
...
//follow user
export const followUserProfile =(userId)=>async(dispatch)=>{
    try {
