...
const LeftSection = () => {
  ...
  return (
    <div className="  flex-col px-1 h-[680px]  py-2 rounded-2xl shadow-lg shadow-slate-300 bg-white border-[1.5px]">
      <div className="flex-col mt-8 px-2  text-center items-center">
        ...
        <div className=" border-b-2">
          <h2 className="mt-5 px-2 text-xl text-gray-700 font-semibold">
            {auth.user?.fullName}
          </h2>
          <p className="text-[#0cac74]">
        ...
        {auth.user?.about ? (
          <p className=" p-2 text-center h-[35vh] overflow-y-scroll hideScroll border-b-2 ">
            <span className="text-lg text-gray-700 ">About</span> <br />
            {auth.user?.about}
          </p>
        ) : (
          ""
