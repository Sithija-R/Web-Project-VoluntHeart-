...
const About = () => {
  return (
    <div
      className="about mt-6 rounded-xl h-[92vh] overflow-y-scroll w-full hideScrollBar bg-white"
      id="aboutId"
    >
      <h1>About Us</h1>
      <p className="intro">
        Building connections, fostering change, one volunteer at a time.
      </p>
            ...
            <div className="inerbox1">
              <div className="whyContent">
                ...
                <div className="whyRow">
                  ...
                  <p>
                    Highlighting economic challenges to emphasize the importance
              ...
              <div className="whyContent whybottom">
                ...
                <div className="whyRow">
                  ...
                  <p>
                    Identifying the key issue faced by volunteers and
                    organizations - lack of efficient means for coordination and
                    connection
                  </p>
                </div>
              </div>
            ...
            <div className="innerbox2">
              <div className="whyContent">
                ...
                <div className="whyRow">
                  ...
                  <p>
                    Emphasizing the consequence of this absence - unmet
              ...
              <div className="whyContent whybottom">
                ...
                <div className="whyRow">
                  ...
                  <p>
                    {" "}
                    Stating the need for a centralized volunteer platform to
      ...
      <div className="boxGoal">
        <div className="columnboxGoal1">
          <div className="boxContent lightGreen">
            ...
            <p>
              Create a centralized platform for seamless connection between
              individuals, organizations, and volunteers.
            </p>
          </div>
          ...
          <div className="boxContent white">
            ...
            <p>
              Enable individuals and organizations facing urgent needs (e.g.,
              food, clothing, shelter, healthcare, education) to seek assistance
              from volunteers.
            </p>
          </div>
        </div>
        <div className="columnboxGoal2"></div>
        <div className="columnboxGoal3">
          <div className="topicGoal">
            <h2>OUR GOALS</h2>
            <p>
              Let's kindle joy in every soul, painting smiles with acts of
              compassion, creating a tapestry of happiness across communities
            </p>
          </div>
          <div className="rowGoalContent">
            <div className="boxContent  blue">
              ...
              <p>
                Encourage active participation and contribution from individuals
                by providing opportunities to volunteer their time, skills, and
                resources for meaningful causes.
              </p>
            </div>
            ...
            <div className="boxContent black">
              ...
              <p>
                Facilitate collaboration among volunteers, organizations, and
                community members to enhance the effectiveness and impact of
                assistance efforts
              </p>
            </div>
          </div>
      ...
      <div className="rowAbout">
        <div className="rowColumn">
          <div className="contentRow">
            ...
            <p>
              Individuals who are eager to donate their time, skills, or
              resources to support various causes, including children's houses,
              elder care facilities, individuals in need, poor families, and
              communities.
            </p>
          </div>
          <div className="contentRow">
            ...
            <p>
              {" "}
              Nonprofits, community groups, or individuals managing children's
              houses, elder care facilities, support programs for individuals in
              need, poverty alleviation initiatives, and community development
              projects.
            </p>
          </div>
        </div>
      ...
      <div className="servicePart">
        <div className="ServiceRow ">
          <div className="service customBlack">
            ...
            <p>
              Robust search enables users to find opportunities by location,
              cause, and skills.
            </p>
          </div>
          ...
          <div className="service">
            ...
            <p>
              Organizations and individuals post needs; volunteers offer
              assistance.
            </p>
          </div>
          ...
          <div className="service customBlack">
            ...
            <p>
              Chat facilitates real-time coordination between volunteers and
              organizations.
            </p>
          </div>
        </div>
        <div className="ServiceRow">
          <div className="service">
            ...
            <p>
              System for users to provide feedback, enhancing future matches and
              outcomes.
            </p>
          </div>
          ...
          <div className="service customBlack">
            ...
            <p>
              Enhances usability, allowing visual identification and engagement
              with nearby opportunities.
            </p>
          </div>
          ...
          <div className="service">
            ...
            <p>
              Tools for organizations to coordinate activities, schedule tasks,
