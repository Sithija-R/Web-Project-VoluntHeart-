...
const Homesection = () => {
  ...
  }, [post.like, post.delete, auth.jwt, post.comment, post.media, post.edit]);
  ...
  return (
    <div className="relative">
      ...
      <div
        className="absolute  w-fit bottom-16 right-5 z-50 text-[#0ca916]  cursor-pointer"
        onClick={handleOpen}
      >
        <Hidden lgUp>
      ...
      <div
        className="hideScrollBar overflow-y-scroll pb-4 space-y-5"
        style={{ height: "86vh" }}
      >
